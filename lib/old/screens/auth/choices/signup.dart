...
import 'package:minelibs2/old/partials/bottom_nav.dart';
import 'package:minelibs2/old/screens/HomeScreen.dart';
import 'package:minelibs2/old/screens/auth/LoginScreen.dart';
import 'package:minelibs2/old/screens/auth/PhoneAuthScreen.dart';
import 'package:minelibs2/old/utils/app.utils.dart';
import 'package:minelibs2/old/utils/transition.utils.dart';

class ChoiceSignUp extends StatefulWidget {
  final PageController pageController;
  const ChoiceSignUp({super.key, required this.pageController});

  @override
  State<ChoiceSignUp> createState() => _ChoiceSignUpState();
}

class _ChoiceSignUpState extends State<ChoiceSignUp> {
  @override
